...
public class HelicopterController : MonoBehaviour
{
    ...
    public float tapSpeed = 0.3f; //in seconds
    ...
    private void returnMenuAndPause() {
        ...
        if (OVRInput.Get(OVRInput.Button.Start)&& OVRInput.Get(OVRInput.Button.SecondaryThumbstick)) {
